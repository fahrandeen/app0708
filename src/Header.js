        ...
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown messages-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer"><a href="fake.url">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li className="dropdown notifications-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer"><a href="fake.url">View all</a></li>
            </ul>
          </li>
          ...
          <li className="dropdown tasks-menu">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="footer">
                <a href="fake.url">View all tasks</a>
              </li>
            </ul>
          </li>
              ...
              <li className="user-body">
                <div className="row">
                  <div className="col-xs-4 text-center">
                    <a href="fake.url">Followers</a>
                  </div>
                  <div className="col-xs-4 text-center">
                    <a href="fake.url">Sales</a>
                  </div>
                  <div className="col-xs-4 text-center">
                    <a href="fake.url">Friends</a>
                  </div>
                </div>
                {/* /.row */}
              </li>
